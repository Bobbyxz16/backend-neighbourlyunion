...
public class TokenResponseRequest {
    ...
    // Constructor
    public TokenResponseRequest(String accessToken, String refreshToken, String tokenType, long expiresIn) {
    ...
    public static class Builder {
        ...
        public TokenResponseRequest build() {
            return new TokenResponseRequest(accessToken, refreshToken, tokenType, expiresIn);
        }
    }
}
