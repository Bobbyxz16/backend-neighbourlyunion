...
* [Spring Cache Abstraction](https://docs.spring.io/spring-boot/3.4.5-SNAPSHOT/reference/io/caching.html)
* [Contract Stub Runner](https://docs.spring.io/spring-cloud-contract/reference/project-features-stubrunner.html)
* [Spring Data Elasticsearch (Access+Driver)](https://docs.spring.io/spring-boot/3.4.5-SNAPSHOT/reference/data/nosql.html#data.nosql.elasticsearch)
